...
PRESETS: dict[str, dict[str, str]] = {
    ...
    # v1.2.0 deleted. clean_notch and clean_sash exist in both lists; the
    # current gallery entries above win, which is intended: those two ids
    # are still in the gallery, so they should track what it means today.
    'prestige_rating_bar': {
        'primary_client': 'stremio_tv_nuvio',
        'top_gradient': 'medium',
